...
class UnixMountEntry {
    ...
    UnixMountEntry(statfs o) {
        name = FFIUtils.toByteArray(o.f_mntfromname$ptr());
        dir = FFIUtils.toByteArray(o.f_mntonname$ptr());
        fstype = FFIUtils.toByteArray(o.f_fstypename$ptr());
        opts = Util.toBytes(MNT_RDONLY == (o.f_flags$get() & MNT_RDONLY) ? "ro" : "");
    }
